 ...
 * Based on the Homework 1 start view class provided by the instructor.
 * Provides the GUI.
 *
 * @author Hongyi Zhen
 * @version 1
...
public class HW1View extends GridPane {
    ...
    public void setColor(Color c, double r, double g, double b) {
        ...
        labelRedValue.setText(String.format("%1$.2f", r));
        labelGreenValue.setText(String.format("%1$.2f", g));
        labelBlueValue.setText(String.format("%1$.2f",  b));
    }
